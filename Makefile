...
bin/kernel.bin: app/kernel.c bin/all_src.c asm/kernel_entry.asm
	...
	gcc -O2 -c app/kernel.c -o bin/kernel.o -m64 -ffreestanding -Wall -Wextra -nostdlib -nostartfiles -Wincompatible-pointer-types -nodefaultlibs -Wunused-variable -Wunused-function -I include
	...
	ld -e 0x7E00 -T link.ld -o bin/kernel.bin bin/entry.o bin/kernel.o bin/compiled.o
